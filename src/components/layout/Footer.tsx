        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <a href="https://space.bilibili.com/209748514" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-800 hover:bg-primary-600 transition-colors">
              ...
              <a href="https://mp.weixin.qq.com/s/eqi0peIX25QuMYaN1uI6qA" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-800 hover:bg-primary-600 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/in/邈霖-oliver-方（fang）-396908105" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-800 hover:bg-primary-600 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
